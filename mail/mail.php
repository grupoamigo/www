...
$sendingAccountUsername     = getenv('EMAIL_USERNAME');;
$sendingAccountPassword     = getenv('EMAIL_PASSWORD');

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'carlosperez@grupoamigo.com, fortunatoperez@grupoamigo.com'; // REQUIRED value.
...
$websiteName                = 'grupoamigo.com';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'America/Monterrey';         // OPTIONAL, but some servers require this to be set. 
